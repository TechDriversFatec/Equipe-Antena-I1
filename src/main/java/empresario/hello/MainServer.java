...
public class MainServer {
    ...
    public static void initializeModelCadi(){
    	...
    	//inicializar usuários professores
		...
		//inicializar empresarios
		modelCadi.addEmpresario(Document.parse("{'email':'teste@teste', 'empresa':'Empresa Teste', 'telefone':'99999999'}"));
